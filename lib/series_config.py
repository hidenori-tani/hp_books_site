...
SERIES_CONFIG = {
    ...
    "souchi-unyou-sedai-manifesto-jp": {
        "order": 2,
        "display_name": "装置運用世代シリーズ — 思想・メモワール",
        "concept": "「意志ではなく装置で生きる」というシリーズの核となる思想と、内的支柱を描いた中核作。",
        "lang": "jp",
    },
    "souchi-unyou-sedai-researcher-jp": {
        "order": 3,
        "display_name": "装置運用世代シリーズ — 研究者向け",
        "concept": "Wet+Dry+AI時代を生き抜く、中年期研究者のための実装書。",
        "lang": "jp",
    },
    "souchi-unyou-sedai-sensitive-jp": {
        "order": 4,
        "display_name": "装置運用世代シリーズ — HSP・繊細思考者向け",
        "concept": "HSP気質と中年期の身体・脳疲労を装置で乗り切るための、神経科学ベースの実装書。",
        "lang": "jp",
    },
    "ai-research-jp": {
        "order": 5,
